...
//
//    Cmdline:
//        sokol-shdc -i src/examples/shaders/shapes.glsl -o src/examples/shaders/shapes.glsl.zig -l glsl410:glsl300es:metal_macos:hlsl5:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
//
//
const vs_source_glsl410 = [621]u8 {
...
pub fn shapesUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniform {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "draw_mode")) {
